...
class FrondendController extends Controller
{
    ...
    public function basicWorkflow()
    {
        return Inertia::render('BasicWorkflow', [
            'navigation' => array(
                'categories' => array(
                    array('id' => 'Menu1', 'name' => 'MENU',
                    'featured' => array(array('name' => 'Doris Hermawan','jabatan' =>'FOUNDER & CHAIRMAN', 'href' => '#', 'imageSrc' => asset("asset/doris.png"), 'imageAlt' => 'Doris Hermawan dengan jabatan FOUNDER & CHAIRMAN.'),
            ...
            'logo' => asset('asset/logo.png'),
            'adetect' => asset('asset/adetect.png'),
            'contentimage' => asset('asset/flow.png'),
        ]);
    }
    ...
    public function ourServices()
    {
        return Inertia::render('OurServices', [
            ...
            'logo' => asset('asset/logo.png'),
            'adetect' => asset('asset/adetect.png'),
            'contentimage' => asset('asset/ourservices.png'),
        ]);
    }

    public function supportService()
    {
        return Inertia::render('SupportService', [
            'navigation' => array(
                'categories' => array(
                    array('id' => 'Menu1', 'name' => 'MENU',
                    'featured' => array(array('name' => 'Doris Hermawan','jabatan' =>'FOUNDER & CHAIRMAN', 'href' => '#', 'imageSrc' => asset("asset/doris.png"), 'imageAlt' => 'Doris Hermawan dengan jabatan FOUNDER & CHAIRMAN.'),
            ...
            'logo' => asset('asset/logo.png'),
            'adetect' => asset('asset/adetect.png'),
            'contentimage' => asset('asset/supportservice.png'),
        ]);
    }
    ...
    public function ourTeam()
    {
        return Inertia::render('OurTeam', [
            ...
            'logo' => asset('asset/logo.png'),
            'adetect' => asset('asset/adetect.png'),
            'contentimage' => asset('asset/ourteam.png'),
        ]);
    }
}